...
namespace specp.DataIntegration
{
    public class FTP
    {
        ...
        static FtpWebRequest CreateRequest(string ftpServer, string ftpUser, string ftpPassword, string ftpFolderName, string ftpFileName)
        {
        ...
        //    return true;
        //}
        public static bool CreateFolder(string ftpServer, string ftpUser, string ftpPassword, string ftpFolderName)
        {
            FtpWebRequest request;
            try
            {
        ...
        public static bool Upload(string ftpServer, string ftpUser, string ftpPassword, string ftpFolderName, string ftpFileName, string srcFileName)
        {
